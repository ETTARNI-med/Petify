...
const ProductsPreviewTest: React.FC<GalleryProps> = ({ categories = CategoryData }) => {
    ...
    <section className=" h-screen">
      ...
      <div className="grid grid-rows-6 grid-cols-2 p-64 pb-4 pt-0 gap-6">
...
const getGridClass = (index: number): string => {
  switch (index) {
    case 1:
      return 'row-span-4 col-span-1 h-46  w-full bg-red-500'; // l3b f size kima bghiti o kheli size tswira kima hya la bghiti drtha 3la 7sab takhod dimesnion dyal div li hya fiha 
    case 2:
      return 'row-span-2 col-span-1 h-56 bg-blue-500 ';
    case 3:
      return 'row-span-2 col-span-1 h-56 bg-yellow-500 ';
    case 4:
      return 'row-span-2 col-span-1 h-56 bg-gray-500';
    case 5:
      return 'row-span-2 col-span-1 h-56 bg-violet-500 ';
    default:
      return '';
  }
};
