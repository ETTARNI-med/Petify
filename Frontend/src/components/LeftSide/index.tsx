...
const LeftSide = () => {
  return (
    <div className="hidden sm:flex sm:-left-16 sm:h-4 sm:w-48 md:h-5 md:w-56 sm:-rotate-90  md:origin-left-bottom  lg:-left-10 fixed items-center justify-between bottom-40">
      <a
        href="/instagram"
