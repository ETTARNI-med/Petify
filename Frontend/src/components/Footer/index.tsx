...
export default function Footer() {
  return (
    <div className="mt-auto grid">
      ...
      <div className="hidden text-xs sm:pt-1 md:text-sm md:pt-3 lg:text-base z-10 h-16 font-semibold text-white bg-fifthcolor p-2 rounded-t xs:flex flex-col">
      ...
      <div className="text-xs md:text-sm lg:text-base p-2 ">
        ...
        <div className="hidden sm:grid gap-5 md:gap-10 lg:gap-8  grid-cols-2 text-center justify-items-center items-center pt-4">
          ...
          <div className="w-full sm:w-11/12 lg:w-10/12 flex flex-col">
            ...
            <div className="grid grid-rows-2 lg:flex py-2 w-full items-center">
              <div className="flex py-1 w-full items-center justify-evenly">
                <div className="gap-1 lg:gap-px flex items-center">
              ...
              <div className="flex py-1 w-full items-center justify-evenly">
                ...
                <div className="gap-1 lg:gap-px flex items-center justify-between">
